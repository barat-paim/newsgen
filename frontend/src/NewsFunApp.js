...
const NewsFunApp = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 font-sans min-h-screen flex flex-col">
      ...
      <div className="flex flex-col md:flex-row bg-gray-100 rounded-lg overflow-hidden">
        <div className="w-full md:w-1/2 p-4 bg-gray-200">
          <textarea 
            className="w-full h-40 p-2 text-lg rounded border border-gray-300" 
        ...
        <div className="w-full md:w-1/2 p-4 bg-gray-300 flex flex-col justify-between">
